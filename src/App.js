...
function App() {
  const [cart, setCart] = useState([{ name: 'Anglerfish', url: '/images/anglerfish.webp', price: 550.00, itemID: 'anglerfish', qty: 3 }, { name: 'Vampire Squid', url: '/images/vampire-squid.jpg', price: 750.00, itemID: 'vampire-squid', qty: 2 }]);
    ...
    <Router>
      <div className="App page-wrapper">
        ...
        <Switch>
          ...
          <Route path='/store/:id'
            render={(props) => (
              <Item {...props} storeItems={storeItems} cart={cart}/>
            )} />
